...
if __name__ == '__main__':
    send_message_via_telegram("I'm sending you a message with an image attached", "../../data/cvcmuscima_staff_removal/CvcMuscima-Distortions/ideal/w-01/image/p001.png")
