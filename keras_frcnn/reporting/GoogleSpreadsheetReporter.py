...
def append_result_to_spreadsheet(dataset_size: int = 140, model_name: str = "vgg4",
                                 configuration_name="many_anchor_box_ratios", data_augmentation="",
                                 early_stopping: int = 20, reduction_patience: int = 8,
                                 learning_rate_reduction_factor: float = 0.5, optimizer: str = "Adadelta",
                                 initial_learning_rate: float = 1.0,
                                 validation_accuracy: float = "0.90", validation_total_loss: float = "0.10",
                                 date: str = "24.12.9999", datasets: str = "muscima_pp",
    ...
    try:
        ...
        data = [dataset_size, model_name, configuration_name, data_augmentation, early_stopping, reduction_patience,
                learning_rate_reduction_factor, optimizer, initial_learning_rate, validation_accuracy,
                validation_total_loss, date, datasets, execution_time_in_seconds]
